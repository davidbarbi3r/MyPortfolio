...
Domaine, hébergement, maintenance : exigez le coût annuel récurrent en plus du prix de création. C'est le chiffre qui manque sur la plupart des devis, et c'est lui qui détermine [le vrai coût du site sur 4 ans](/combien-coute-site-internet-corse/). Pour situer : la [maintenance](/maintenance-site-internet-ajaccio/) va de 0 € pour un site statique bien construit à plusieurs centaines d'euros par an pour un WordPress chargé.
